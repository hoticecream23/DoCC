...
def evaluate(gold_path, pred_path, unknown_label: str = "unknown") -> dict:
...
def compare(gold_path, a_path, b_path, unknown_label: str = "unknown") -> dict:
    """Score two prediction files against the same gold and diff them."""
    ra = evaluate(gold_path, a_path, unknown_label)
    rb = evaluate(gold_path, b_path, unknown_label)
